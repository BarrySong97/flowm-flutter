...
// 期间范围选择器状态
final periodRangeProvider =
    StateProvider<PeriodRange>((ref) => PeriodRange.month);
    ...
    case PeriodRange.year:
      ...
      for (int month = 1; month <= 12; month++) {
        ...
        final monthlyExpense =
            expenseChartData.fold(0.0, (sum, data) => sum + data.y);
        final monthlyIncome =
            incomeChartData.fold(0.0, (sum, data) => sum + data.y);

        monthlyData.add(
            MonthlyComparisonData('$month月', monthlyExpense, monthlyIncome));
      }
      break;
      ...
      if (customRange != null) {
        ...
        if (daysDifference <= 31) {
          ...
          for (int i = 0; i < daysDifference; i++) {
            ...
            final dayEnd = DateTime(currentDate.year, currentDate.month,
                currentDate.day, 23, 59, 59);

            final expenseChartData =
                await expenseRepository.getExpenseChartData(
              startDate: dayStart,
              endDate: dayEnd,
              ledgerId: ledgerId,
            );
          ...
          final isFullYearRange = startDate.month == 1 &&
              startDate.day == 1 &&
              endDate.month == 12 &&
              endDate.day == 31 &&
          ...
          while (currentMonth.isBefore(endMonth) ||
            ...
            final monthEnd = DateTime(
                currentMonth.year, currentMonth.month + 1, 0, 23, 59, 59);
