...
class ExpenseRepository {
  ...
  /// 获取指定账户及其子账户在特定时间范围内的总支出余额
  ///
  /// [accountId] 要查询的支出账户ID
  /// [startDate] 开始时间
  /// [endDate] 结束时间
  Future<double> getAccountExpenseBalance({
    ...
    try {
      ...
      print('[ExpenseRepository] Error in getAccountExpenseBalance: $e');
      print('[ExpenseRepository] Stacktrace: $s');
      return 0.0;
    }
  }
  ...
  Future<double> getAccountExpenseTotalBalance({
    ...
    try {
      ...
      print('[ExpenseRepository] Error in getAccountExpenseTotalBalance: $e');
      print('[ExpenseRepository] Stacktrace: $s');
      return 0.0;
    }
  }
